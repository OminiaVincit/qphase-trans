...
def main(PostProcess=False, muvals=50, tvals=50):
    ...
    **Arguments**
    ...
    parameters_template = {
        # Directories
        'job_ID'                    : 'HCDipolar',
        'Write_Directory'           : 'TMP_10/',
        'Output_Directory'          : 'OUTPUTS_10/',
    ...
    staticsParameters = mps.WriteMPSParallelTemplate(parameters_template,
    ...
    if(PostProcess):
        # extract observables
        Outputs = mps.ReadStaticObservables(staticsParameters, myObservables)

        # heading for where postprocessing is to be written
        outputstub = 'HCDOut/' + staticsParameters[0]['job_ID']
